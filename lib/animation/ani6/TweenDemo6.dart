...
import 'package:flutter_demo/animation/ani5/BarChartPainter5.dart';

/// 补间，它是构建动画代码的一个非常简单的概念，
/// 主要作用是用面向对象的方法替代之前面向过程的方法。
/// tween是一个值，它描述了其他值的空间中的两个点之间的路径，
/// 比如条形图的动画值从0运行到1。
class TweenDemo6 extends StatefulWidget {
  static var routeName="/TweenDemo6";
...
class _TweenDemoState2 extends State<TweenDemo6> with TickerProviderStateMixin {
  //随机函数
